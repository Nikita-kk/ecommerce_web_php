...
$row_category=mysqli_fetch_assoc($result_brands);
$brands_title=$row_category['brands_title'];
// echo $brands_title ;
...
if(isset($_POST['edit_product'])){
    ...
    if($product_title=='' or $product_desc==''or $product_keywords=='' or
      $product_category=='' or $product_brands=='' or $product_image1=='' 
    //   $product_image2=='' or $product_image3=='' 
      or $product_price==''){
        echo "<script>alert('Please fill all field and continue the process')</script>";
      }else{
        ...
        category_id='$product_category', brands_id='$product_brands',
