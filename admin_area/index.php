            ...
            <div class="container-fluid">
                ...
                <nav class="navbar navbar-expand-lg ">
                    <ul class="navbar-nav">
                     ...
                     ?>
                            <a href="" class="nav-link">welcome  <?php echo $user_username; ?> </a>
                        </li>
                    </ul>
                </nav>
            </div>
        ...
        <div class="row">
            <div class="col-md-12 bg-secondary p-1 d-flex align-items-center">
                ...
                <div>
                    ...
                    <a href=""><img src="../images/pineapple-juice.jpg" alt="" class="admin-image"></a>
                    <p class="text-light text-center">Admin <?php echo $user_username; ?> </p>
                </div>
                <!-- button*10>a.nav-text.text-light.bg-info.my-1 -->
                <div class="button text-center">
                    <button class="my-3"><a href="index.php?insert_product" class="nav-link text-light bg-info my-1">Insert
                            Product</a></button>
